      ...
      <div className="header header-transparent py-1 py-lg-0">
        <div className="header-inner container">
          <div className="header-brand">
            <a className="header-brand-text header-brand-text-sm" href="index.html" title="Home">
              <h1>
                <span className="header-brand-text-alt">Chii</span>ki<span className="header-brand-text-alt">.</span>
              </h1>
            </a>
            <div className="header-divider d-none d-lg-block"></div>
            <div className="header-slogan text-sm d-none d-lg-block">Something here?</div>
          </div>
          ...
          <div className="navbar navbar-expand-md">
            <div className="navbar-main collapse">
              <ul className="nav navbar-nav navbar-dark mr-lg-2 dropdown-effect-fade">
                <li className="nav-item d-lg-flex">
                  <a href="index.html" className="nav-link"> <i className="fas fa-home nav-link-icon"></i> <span className="d-none">Home</span> </a>
                </li>
            ...
            <a href="#" className="btn btn-primary btn-rounded btn-sm text-uppercase font-weight-bold">Post Job</a>
          </div>
        </div>
      </div>
    </div>
